...
```
processing file: VizGenomicsData.Rpres
...
Quitting from lines 1303-1306 (VizGenomicsData.Rpres) 
Error: XML content does not seem to be XML: 
In addition: Warning messages:
1: package 'Gviz' was built under R version 3.3.1 
2: package 'S4Vectors' was built under R version 3.3.1 
3: package 'GenomeInfoDb' was built under R version 3.3.1 
4: package 'GenomicFeatures' was built under R version 3.3.1 
5: package 'AnnotationDbi' was built under R version 3.3.1 
6: package 'XVector' was built under R version 3.3.1 
Execution halted
```
